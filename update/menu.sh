...
Isadmin=$(curl -sS https://raw.githubusercontent.com/Locu-Locu/permission/main/ipmini | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/Locu-Locu/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
06 | 6) clear ; menu-dns ;;
07 | 6) clear ; menu-dns ;;
08 | 7) clear ; menu-theme ;;
09 | 8) clear ; menu-backup ;;
10 | 9) clear ; menu-set ;;
12) clear ; info ;;
13) clear ; add-host ;;
14) clear ; crtxray ;;
